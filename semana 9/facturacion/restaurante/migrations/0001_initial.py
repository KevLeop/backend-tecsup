    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('platoDescripcion', models.CharField(db_column='plato_descripcion', max_length=50, verbose_name='Descripcion del plato')),
                ('platoCantidad', models.IntegerField(db_column='plato_cantidad', verbose_name='Cantidad de platos')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('personalCorreo', models.EmailField(db_column='personal_correo', max_length=30, unique=True, verbose_name='Correo del usuario')),
                ('personalTipo', models.IntegerField(choices=[(1, 'ADMINISTRADOR'), (2, 'CAJERO'), (3, 'MOZO')], db_column='personal_tipo', verbose_name='Tipo de usuario')),
